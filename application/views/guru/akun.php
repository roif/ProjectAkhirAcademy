                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <a href="<?= base_url() ?>Guru/ubahpassword" class="btn btn-success">Ubah Password</a>
                        </div>
                    </div>
                </div>
            </div>
            <a href="<?= base_url() ?>Guru" class="btn btn-primary">Home</a>
            <a href="<?= base_url() ?>Guru/hapus" class="btn btn-link">Hapus Akun</a>
        </div>
    </div>
</div>